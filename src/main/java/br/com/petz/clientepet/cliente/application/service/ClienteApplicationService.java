...
import br.com.petz.clientepet.cliente.application.api.ClienteAlteraçaoRequest;
...
public class ClienteApplicationService implements ClienteService {
	...
	@Override
	public void patchAlteraCliente(UUID idCliente, ClienteAlteraçaoRequest clienteAlteraçaoRequest) {
		log.info("[inicia] ClienteApplicationService - patchAlteraCliente");
		Cliente cliente = clienteRepository.buscaClienteAtravesId(idCliente);
		cliente.altera(clienteAlteraçaoRequest);
