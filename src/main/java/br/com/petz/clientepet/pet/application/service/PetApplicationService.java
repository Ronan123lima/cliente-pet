...
import br.com.petz.clientepet.pet.application.api.PetAuteracaoRequest;
...
public class PetApplicationService implements PetService {
	...
	@Override
	public void alteraPetDoClienteComId(UUID idCliente, UUID idPet, PetAuteracaoRequest petAuteracaoRequest) {
		log.info("[start] PetApplicationService - alteraPetDoClienteComId");
		clienteService.buscaClienteAtravesId(idCliente);
		Pet pet = petRepository.buscaPetPeloId(idPet);
		pet.altera(petAuteracaoRequest);
